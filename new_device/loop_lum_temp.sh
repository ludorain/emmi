...
BASE_DIR=$(pwd)
ORIGINALS_DIR="$BASE_DIR/new_device/files_v=9/1originals"
PROCESSED_DIR="$BASE_DIR/new_device/files_v=9/2processed"
COORD_DIR="$BASE_DIR/new_device/files_v=9/3coordinates"
ROOT_DIR="$BASE_DIR/new_device/files_v=9/4th2f"
LUM_DIR="$BASE_DIR/new_device/files_v=9/luminosity"
