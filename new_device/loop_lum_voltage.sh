...
ORIGINALS_DIR="$BASE_DIR/new_device/files_T=20/1originals"
PROCESSED_DIR="$BASE_DIR/new_device/files_T=20/2processed"
COORD_DIR="$BASE_DIR/new_device/files_T=20/3coordinates"
ROOT_DIR="$BASE_DIR/new_device/files_T=20/4th2f"
LUM_DIR="$BASE_DIR/new_device/files_T=20/luminosity"
