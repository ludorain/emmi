...
ORIGINALS_DIR="$BASE_DIR/study_on_radius/DATA_R_isol_60/bef_ann_A1_T=20_r=26/1originals"
PROCESSED_DIR="$BASE_DIR/study_on_radius/DATA_R_isol_60/bef_ann_A1_T=20_r=26/2processed"
COORD_DIR="$BASE_DIR/study_on_radius/DATA_R_isol_60/bef_ann_A1_T=20_r=26/3coordinates"
ROOT_DIR="$BASE_DIR/study_on_radius/DATA_R_isol_60/bef_ann_A1_T=20_r=26/4th2f"
LUM_DIR="$BASE_DIR/study_on_radius/DATA_R_isol_60/bef_ann_A1_T=20_r=26/luminosity"
...
python find_defects_isolated_fixedR.py \
    --input "$ref_processed" \
