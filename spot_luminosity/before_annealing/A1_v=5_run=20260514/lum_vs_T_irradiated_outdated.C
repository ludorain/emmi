// ============================================================
// 
// root -l 'lum_vs_T_irradiated_outdated.C("A1_v=5_run=20260514-062228_total_global_ID.csv")'
//lum_vs_T_irradiated_outdated.C
//
// CSV atteso:
...
// Uso:
// root -l
// .x lum_vs_T_irradiated_outdated.C("nome_file.csv")
//
// Oppure, scegliendo lo spot della canvas 4:
// .x lum_vs_T_irradiated_outdated.C("nome_file.csv", 3)
// ============================================================
...
void lum_vs_T_irradiated_outdated(const char* filename = "data.csv", int selected_spot = 3) {
    ...
    gr_B->SetTitle("Exponential fit parameter B vs spot ID before annealing;Spot;B");
    ...
    TCanvas* c6 = new TCanvas(
        ...
        "Chi square exponential fit vs spot ID before annealing",
        1000,
        800
    );
    ...
    gr_chi2->SetTitle("#chi^{2} of exponential fit vs spot ID before annealing;Spot;#chi^{2}");
    ...
    c6->SaveAs("A1_beff_ann_lum_vs_T_chi2.png");
}