// ============================================================
// 
// root -l 'lum_vs_T_irradiated.C("A1_v=5_run=20260702-101218_total.csv")'
...
void lum_vs_T_irradiated(const char* filename = "data.csv", int selected_spot = 7) {
    ...
    gr_c1->SetTitle(
        Form("Luminosity at maximum temperature T = %.1f #circC, v = %.1f - Annealing 100#circC 25h;Spot;Luminosity",
             Tmax, v_const)
    );
    ...
    c1->SaveAs("A1_ann_100_25_lum_vs_T_maxT.png");
    ...
    gr_c2->SetTitle(
        Form("Luminosity at maximum temperature T = %.1f #circC, v = %.1f Annealing 100#circC 25h - focus;Spot;Luminosity",
             Tmax, v_const)
    );
    ...
    c2->SaveAs("A1_ann_100_25_lum_vs_T_maxT_focus.png");
    ...
    c3->SaveAs("A1_ann_100_25_lum_vs_T_first8_expfit.png");
    ...
    if (spots.find(selected_spot) != spots.end()) {
        ...
        gr->SetTitle(
            Form("Spot %d: x = %.2f, y = %.2f, v = %.1f;T (#circC) Annealing 100#circC 25h;Luminosity",
    ...
    gr_B->SetTitle("Exponential fit parameter B vs spot ID Annealing 100#circC 25h (#chi^{2}/ndf < 2);Spot;B");
    ...
    c5->SaveAs("A1_ann_100_25_lum_vs_T_B.png");
    // ============================================================
    // CANVAS 6:
    ...
    TCanvas* c6 = new TCanvas(
        ...
        "Chi square exponential fit vs spot ID Annealing 100#circC 25h",
        1000,
        800
    );
    ...
    gr_chi2->SetTitle("#chi^{2} of exponential fit vs spot ID Annealing 100#circC 25h;Spot;#chi^{2}");
    ...
    c6->SaveAs("A1_ann_100_25_lum_vs_T_chi2.png");
}